...
public class GoblinBoss extends EntityZombie implements Boss{
...
//	Map<UUID,Double> damages = new HashMap<UUID,Double>();
	...
	private static final DataWatcherObject<Boolean> bw = DataWatcher.a((Class) GoblinBoss.class, DataWatcherRegistry.i);

	private static final DataWatcherObject<Integer> bx = DataWatcher.a((Class) GoblinBoss.class, DataWatcherRegistry.b);

	public static final DataWatcherObject<Boolean> DROWN_CONVERTING = DataWatcher.a((Class) GoblinBoss.class,
	...
	protected void b(EntityTypes<? extends EntityZombie> entitytypes) {
		if (!this.dead) {
			GoblinBoss entityzombie = (GoblinBoss) entitytypes.a(this.world);
			entityzombie.u(this);
	...
	public boolean a(EntityHuman entityhuman, EnumHand enumhand) {
		...
		if (item instanceof ItemMonsterEgg && ((ItemMonsterEgg) item).a(itemstack.getTag(), getEntityType())) {
			if (!this.world.isClientSide) {
				GoblinBoss entityzombie = (GoblinBoss) getEntityType().a(this.world);
	...
	class a extends PathfinderGoalRemoveBlock {
		...
		public void a(GeneratorAccess generatoraccess, BlockPosition blockposition) {
			generatoraccess.playSound((EntityHuman) null, blockposition, SoundEffects.ENTITY_ZOMBIE_DESTROY_EGG,
					SoundCategory.HOSTILE, 0.5F, 0.9F + GoblinBoss.this.random.nextFloat() * 0.2F);
		}
